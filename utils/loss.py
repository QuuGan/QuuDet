...
class ComputeLossYOLOv1:
    ...
    def __call__(self, pred, target):
        ...
        :param label:Dataset (batch_size,30,7,7) label
        ...
        return loss ,torch.cat((torch.tensor(noobj_loss).unsqueeze(0), torch.tensor(obj_loss).unsqueeze(0), torch.tensor(classes_loss).unsqueeze(0), loss.unsqueeze(0))).detach()
